...
<div class="min-vh-100 d-flex align-items-center justify-content-center"
    ...
    <div class="col-12 col-md-5">
        <div class="card border-0 shadow-lg text-center p-5" style="border-radius:16px">
            ...
            <h4 class="fw-bold mt-3">Verification Link Expired or Invalid</h4>
            <p class="text-muted mt-2">This verification link has either expired or already been used.
               Please log in and request a new verification email from your dashboard.</p>
